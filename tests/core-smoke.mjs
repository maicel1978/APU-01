...
const cases = [
  ...
  { file: fileLike('nota-whatsapp.opus', 1 * MB, 'audio/opus'), expect: 'ok' },
  { file: fileLike('grabacion-iphone.m4a', 1 * MB, 'audio/mp4'), expect: 'ok' },
  { file: fileLike('captura-web.webm', 1 * MB, 'audio/webm'), expect: 'ok' },
